...
function Question() {
  ...
  return (
    <>
    <div className='mt-4 ml-4 mb-4 mr-2 w-full'>
    <p className="text-3xl font-bg">
      1. Two Sum
    </p>
    ...
    <p>&nbsp;</p>
    <div className='flex flex-col m-2 p-2 bg-gray-300 rounded-md'>
      <p><strong className="flex flex-col">Example 1:</strong></p>
      <pre>
